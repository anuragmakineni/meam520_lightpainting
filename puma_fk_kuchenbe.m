function [points_to_plot, x60, y60, z60] = puma_fk_kuchenbe(theta1, theta2, theta3, theta4, theta5, theta6)
%
...
% coordinates for the starting and ending points of vectors along the
% x, y, and z axes of the robot's sixth frame (the end-effector
% frame).
...
% unit vectors of frame 6 in frame 0. Each of these vectors starts at
% the origin of frame 6 and ends at the distance vlen along the
% designated axis.  We calculate the location of the end by
% multiplying T60 into a scaled unit vector in the correct direction.
x60 = [o6 (T60 * [vlen 0 0 1]')];
y60 = [o6 (T60 * [0 vlen 0 1]')];
z60 = [o6 (T60 * [0 0 vlen 1]')];
